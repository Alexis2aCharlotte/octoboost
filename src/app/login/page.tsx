    ...
    <main className="flex min-h-screen flex-col bg-background">
      ...
      <div className="relative z-10 mx-auto flex flex-1 w-full max-w-sm items-center px-6 pt-16">
       <div className="w-full">
        ...
        {/* Google OAuth — hidden until provider is configured
        <button
          onClick={handleGoogleAuth}
          disabled={googleLoading}
          className="flex w-full items-center justify-center gap-3 rounded-lg border border-border bg-card px-4 py-2.5 text-sm font-medium transition-colors hover:border-accent/30 hover:bg-card-hover disabled:opacity-50"
        >
          {googleLoading ? (
